...
@Component({
  selector: 'report-student-income-summary-search',
  templateUrl: './report-student-income-summary-search.component.html',
  styleUrls: ['./report-student-income-summary-search.component.scss']
})
export class ReportStudentIncomeSummarySearchComponent implements OnInit {
  searchInput = {
    programs : '',
    year : '',
    sector : '',
    ...
    if (this.searchInput.programs == null) {
      ...
      if (this.searchInput.year == '') {
        ...
        if (this.searchInput.sector == '') {
          ...
          this.router.navigate(['app/report_student_inexamroom/list'])
        }
      }
