...
@Component({
  selector: 'report-student-admissions-search',
  templateUrl: './report-student-admissions-search.component.html',
  styleUrls: ['./report-student-admissions-search.component.scss']
})
export class ReportStudentAdmissionsSearchComponent implements OnInit {
    ...
    if (this.searchInput.programs == null) {
      ...
      if (this.searchInput.year == '') {
        ...
        if (this.searchInput.sector == '') {
          ...
          this.Router.navigate(['app/report_student_admissions/list'])
        }
      }
