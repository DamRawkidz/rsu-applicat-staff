...
@Component({
  selector: 'report-exam-room-search',
  templateUrl: './report-exam-room-search.component.html',
  styleUrls: ['./report-exam-room-search.component.scss']
})
export class ReportExamRoomSearchComponent implements OnInit {
    ...
    if (this.searchInput.programs == null) {
      ...
      if (this.searchInput.year == '') {
        ...
        if (this.searchInput.sector == '') {
          ...
          this.Router.navigate(['app/report_exam_room/list'])
        }
      }
