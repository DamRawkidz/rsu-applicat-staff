...
@Component({
  selector: 'report-list-applicants-address-search',
  templateUrl: './report-list-applicants-address-search.component.html',
  styleUrls: ['./report-list-applicants-address-search.component.scss']
})
export class ReportListApplicantsAddressSearchComponent implements OnInit {
    ...
    if (this.searchInput.programs == null) {
      ...
      if (this.searchInput.year == '') {
        ...
        if (this.searchInput.sector == '') {
          ...
          this.Router.navigate(['app/report_applicants_address/list'])
        }
      }
