...
@Component({
  selector: 'report-summary-applicants-faculty-college-search',
  templateUrl: './report-summary-applicants-faculty-college-search.component.html',
  styleUrls: ['./report-summary-applicants-faculty-college-search.component.scss']
})
export class ReportSummaryApplicantsFacultyCollegeSearchComponent implements OnInit {
    ...
    if (this.searchInput.programs == null) {
      ...
      if (this.searchInput.year == '') {
        ...
        if (this.searchInput.sector == '') {
          ...
          this.Router.navigate(['app/report_summary_applicants_faculty/list'])
        }
      }
