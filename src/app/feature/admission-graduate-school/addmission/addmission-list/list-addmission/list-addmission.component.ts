...
export class ListAddmissionComponent implements OnInit {
  ...
  rows = [
    {'application_id':'02112565001','first_name_th':'นายอดิศร ศรีสุธรรม','course':'สาขาภาษาอังกฤษ คณะศิลปศาสตร์ ปริญญาตรี (ไทย)','program_code':'สมัครเรียนระดับบัณฑิตศึกษา','date':'10/02/2565','application_status_name_th':'รับเงินค่าสมัครรอนัดวันสัมภาษณ์'},
    {'application_id':'02112565001','first_name_th':'นายอดิศร ศรีสุธรรม','course':'สาขาภาษาอังกฤษ คณะศิลปศาสตร์ ปริญญาตรี (ไทย)','program_code':'สมัครเรียนระดับบัณฑิตศึกษา','date':'10/02/2565','application_status_name_th':'รอตรวจสอบเอกสาร'},
    {'application_id':'02112565001','first_name_th':'นายอดิศร ศรีสุธรรม','course':'สาขาภาษาอังกฤษ คณะศิลปศาสตร์ ปริญญาตรี (ไทย)','program_code':'สมัครเรียนระดับบัณฑิตศึกษา','date':'10/02/2565','application_status_name_th':'รอชำระค่าใบสมัคร'},
  ...
  addPage() {
    this.router.navigate(['app/addmission/add'])
  }
}
